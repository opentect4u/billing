...
const { comp_list, show_header_footer_flag, save_edit_header_footer, save_add_header_footer } = require('../module/Header_footerModule');
...
Header_footerRouter.get('/edit_header_footer',async(req, res) =>{
    ...
    var res_dt = {
        show_header_footer_dt: show_header_footer_dtls.suc > 0 ? show_header_footer_dtls.msg : [],
    }
    // console.log(res_dt);
